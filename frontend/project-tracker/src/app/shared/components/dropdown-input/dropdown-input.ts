...
/// <summary>
/// Reusable dropdown/select input component with Bootstrap 5.3 styling
...
@Component({
  ...
  providers: [{
    ...
    useExisting: forwardRef(() => DropdownInput),
    multi: true
  }]
})
export class DropdownInput implements ControlValueAccessor, OnInit {
