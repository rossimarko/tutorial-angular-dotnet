---
applyTo: "ProjectTracker.FrontEnd/src/**/*.{ts,html,css,scss}"
---
...
- Always separate concerns across these files (no inline templates/styles except for trivial components)

## Anti-patterns to Avoid
- Zone pollution with manual change detection
- Overusing `effect()` for side effects
- Mixing signals with observables unnecessarily
