...
/// <summary>
/// Validator for CreateProjectRequest using FluentValidation
...
{
    /// <summary>
    /// Initializes validation rules for creating a new project
    /// </summary>
    ...
    private static bool ValidateDateRange(CreateProjectRequest request)
    {
